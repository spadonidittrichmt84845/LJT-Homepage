...
1. **SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond** (2025)  
   **Junteng Liu** (first author), Yuanxiang Fan, Zhuo Jiang, Han Ding, Yongyi Hu, Chi Zhang, Yiqi Shi, Shitong Weng, Aili Chen, Shiqi Chen, Yunan Huang, Mozhi Zhang, Pengyu Zhao, Junjie Yan, Junxian He. *Arxiv*. (GitHub code repository available)

2. **On the Perception Bottleneck of VLMs for Chart Understanding** (2025)  
   **Junteng Liu** (first author), Weihao Zeng, Xiwen Zhang, Yijun Wang, Zifei Shan, Junxian He. *Arxiv*. (GitHub code repository: Vision4Chart)

3. **On the Universal Truthfulness Hyperplane Inside LLMs** (2024)  
   **Junteng Liu** (first author), Shiqi Chen, Yu Cheng, Junxian He. *EMNLP 2024*. (GitHub code repository: Universal_Truthfulness_Hyperplane)
